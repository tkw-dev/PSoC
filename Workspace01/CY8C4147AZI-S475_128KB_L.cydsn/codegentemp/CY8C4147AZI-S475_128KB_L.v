// ======================================================================
// CY8C4147AZI-S475_128KB_L.v generated from TopDesign.cysch
// 05/04/2023 at 19:36
...
module CapSense_P4_v7_0_0 ;
    ...
    defparam CSD.sensors_count = 18;
    defparam CSD.shield_as_sense = 0;
    defparam CSD.shield_count = 1;
    defparam CSD.tx_count = 1;

	wire [17:0] tmpOE__Sns_net;
	wire [17:0] tmpFB_17__Sns_net;
	wire [17:0] tmpIO_17__Sns_net;
	wire [0:0] tmpINTERRUPT_0__Sns_net;
	electrical [0:0] tmpSIOVREF__Sns_net;

	cy_psoc3_pins_v1_10
		#(.id("4a5beadb-d49b-48ff-ade2-08c375747d58/77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .init_dr_st(18'b0_1_1_1_1_1_1_1_1_1_1_1_1_1_1_1_1_1),
		  .input_clk_en(0),
		  .input_sync(18'b0_0_0_0_0_0_0_0_0_0_0_0_0_0_0_0_0_0),
		  ...
		  .pa_out_clock_en(-1),
		  .pa_out_reset(-1),
		  .pin_aliases("Button0_Sns0,Button1_Sns0,Touchpad0_Col0,Touchpad0_Col1,Touchpad0_Col2,Touchpad0_Col3,Touchpad0_Col4,Touchpad0_Col5,Touchpad0_Row0,Touchpad0_Row1,Touchpad0_Row2,Touchpad0_Row3,Touchpad0_Row4,Touchpad0_Row5,Button2_Sns0,Button3_Sns0,Button4_Sns0,Button5_Sns0"),
		...
		Sns
		 (.oe(tmpOE__Sns_net),
		  .y({18'b0}),
		  .fb({tmpFB_17__Sns_net[17:0]}),
		  .analog({Net_2[17:0]}),
		  .io({tmpIO_17__Sns_net[17:0]}),
	...
	assign tmpOE__Sns_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{18'b111111111111111111} : {18'b111111111111111111};
	...
	cy_psoc3_pins_v1_10
		#(.id("4a5beadb-d49b-48ff-ade2-08c375747d58/7850aeaf-db25-4eae-b828-015ef596b59e"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("4a5beadb-d49b-48ff-ade2-08c375747d58/a8285cdc-5e81-40c0-8036-58ea5f8c1102"),
...
module ADC_SAR_SEQ_P4_v2_50_3 (
	...
	cy_clock_v1_0
		#(.id("39d2a23e-d748-4399-a484-897c84101491/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
...
module SCB_P4_v4_0_4 (
	...
	cy_clock_v1_0
		#(.id("160dd917-0c39-42f6-9833-25c9ea89b0a6/2dc2d7a8-ce2b-43c7-af4a-821c8cd73ccf"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("160dd917-0c39-42f6-9833-25c9ea89b0a6/23b8206d-1c77-4e61-be4a-b4037d5de5fc"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
...
module top ;
	...
	wire [0:0] tmpOE__BATTRead_net;
	wire [0:0] tmpFB_0__BATTRead_net;
	wire [0:0] tmpIO_0__BATTRead_net;
	wire [0:0] tmpINTERRUPT_0__BATTRead_net;
	electrical [0:0] tmpSIOVREF__BATTRead_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		BATTRead
		 (.oe(tmpOE__BATTRead_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__BATTRead_net[0:0]}),
		  .analog({Net_161}),
		  .io({tmpIO_0__BATTRead_net[0:0]}),
		  .siovref(tmpSIOVREF__BATTRead_net),
		  .interrupt({tmpINTERRUPT_0__BATTRead_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__BATTRead_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__PushSW_net;
	wire [0:0] tmpFB_0__PushSW_net;
	wire [0:0] tmpIO_0__PushSW_net;
	wire [0:0] tmpINTERRUPT_0__PushSW_net;
	electrical [0:0] tmpSIOVREF__PushSW_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		PushSW
		 (.oe(tmpOE__PushSW_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PushSW_net[0:0]}),
		  .io({tmpIO_0__PushSW_net[0:0]}),
		  .siovref(tmpSIOVREF__PushSW_net),
		  .interrupt({tmpINTERRUPT_0__PushSW_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PushSW_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_clock_v1_0
		#(.id("da65529e-8397-45e7-bf32-455dbdcdbb60"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__IlluminationPWM_net;
	wire [0:0] tmpFB_0__IlluminationPWM_net;
	wire [0:0] tmpIO_0__IlluminationPWM_net;
	wire [0:0] tmpINTERRUPT_0__IlluminationPWM_net;
	electrical [0:0] tmpSIOVREF__IlluminationPWM_net;

	cy_psoc3_pins_v1_10
		#(.id("f9e8a0aa-ecf1-42b3-ab91-bd36f51c7c43"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		IlluminationPWM
		 (.oe(tmpOE__IlluminationPWM_net),
		  .y({Net_50}),
		  .fb({tmpFB_0__IlluminationPWM_net[0:0]}),
		  .io({tmpIO_0__IlluminationPWM_net[0:0]}),
		  .siovref(tmpSIOVREF__IlluminationPWM_net),
		  .interrupt({tmpINTERRUPT_0__IlluminationPWM_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__IlluminationPWM_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_clock_v1_0
		#(.id("a5e7b5be-57a5-45d4-8369-328da4431d51"),
		  .source_clock_id("413DE2EF-D9F2-4233-A808-DFAF137FD877"),
		  .divisor(480),
		  .period("0"),
		  .is_direct(0),
